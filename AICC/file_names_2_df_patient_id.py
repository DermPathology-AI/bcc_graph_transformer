...
def file_names_2_df_patient(ndpi_files, split_by='/'):
    
    def get_final_annotation(combined_annot):
        if combined_annot in ['1b','1b_JS_1b']:                    final_label = 1
            ...
            combined_annot = combined_annot.split('_C_')[-1]
            if combined_annot in ['1b']:                    final_label = 1
            elif combined_annot in ['1a']: final_label = 2
            elif combined_annot in ['2'] :             final_label = 3
            elif combined_annot in ['3']  :            final_label = 4
            elif combined_annot in ['0']:              final_label = 0
    ...
    for i, name_annotation in enumerate(name_annotations):
        if len(name_annotation)== 2 :
            ...
            final_label = get_final_annotation(combined_annot)
    ...
    annotated.columns = ['bcc code', 'address', 'names', 'temp label','label']
