...
if __name__ == '__main__':
    ...
    parser.add_argument('-u', '--holdout_set', type=bool, default=False, help='Test set') # Filmon added this
    ...
    path_base = os.path.join('/workspace/data/bcc-projekt-digital/', args.dataset)
    ...
    if args.holdout_set:
        ...
        if len(levels) == 2:
            out_base = os.path.join('WSI_test_set', args.dataset, 'pyramid')
        else:
            out_base = os.path.join('WSI_test_set', args.dataset, 'single')
