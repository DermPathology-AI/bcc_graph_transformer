...
--val_set    "/workspace/data/cv_methods/tmi2022/scripts/test_set_cv.txt" \
...
--task_name  "GT_double_3C_2F_test" \
--batch_size 2 \
--test  \
--log_interval_local 1 \
--resume "/workspace/data/cv_methods/tmi2022/graph_transformer/saved_models/GT_double_3C_2F.pth"
