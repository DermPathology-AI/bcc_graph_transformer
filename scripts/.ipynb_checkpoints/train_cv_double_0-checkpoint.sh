...
--train_set  "/workspace/data/cv_methods/tmi2022/scripts/train_set_0.txt" \
--val_set    "/workspace/data/cv_methods/tmi2022/scripts/val_set_0.txt" \
