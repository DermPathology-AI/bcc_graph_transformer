...
python main.py \
--n_class 5 \
--data_path  "/workspace/data/cv_methods/tmi2022/graphs/simclr_files_double_high/" \
...
--resume "/workspace/data/cv_methods/tmi2022/graph_transformer/saved_models/GT_5C_3F_high.pth"
