...
--train_set  "/workspace/data/cv_methods/tmi2022/scripts/train_set_5C_1F.txt" \
--val_set    "/workspace/data/cv_methods/tmi2022/scripts/val_set_5C_1F.txt" \
